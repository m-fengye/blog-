        ...
        <div class="cd-hero">
                    ...
                    <div class="tm-navbar-bg">
                        ...
                        <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#0" data-no="6">Leave Word</a>
                                </li>
                            </ul>
                        </div>                        
                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-2-col-left">
                                                <div class="text-xs-left tm-textbox tm-2-col-textbox">
                                                    ...
                                                    <p class="tm-text">
                                                        ...
                                                        If you have any questions,you can ask me,Let's learn and make progress together.</p>
                                                </div>
                                            </div>
            ...
            <footer class="tm-footer">
                ...
                <div class="tm-footer-copyright">
                    <p class="tm-copyright-text">If you have any questions or suggestions on this website, please contact me 
                    ...
                    <br />
                    <p class="tm-copyright-text">Copyright &copy; 2019 Fengye - 
