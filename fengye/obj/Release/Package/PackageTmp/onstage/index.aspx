<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="fengye.index" %>
...
<head>
    ...
    <title>Love FengYe,Love Life</title>
    <!-- load stylesheets -->
...
<body>
    ...
    <div class="cd-hero">
        <div class="loginout">
            ...
            <a href='../LoginOut.aspx'>Login Out&emsp;</a>
        </div>
        ...
        <div class="cd-slider-nav">
            <nav class="navbar">
                <div class="tm-navbar-bg">
                    ...
                    <a class="navbar-brand text-uppercase" href="#"><i class="fa fa-send-o tm-brand-icon"></i>FENGYE</a>
                    ...
                    <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#0" data-no="3">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#0" data-no="4">Code</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#0" data-no="5">Blank1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#0" data-no="6">Blank2</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="tm-2-col-container tm-bg-white-translucent">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h2 class="tm-text-title">Site Intro</h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-2-col-left">
                                            <div class="text-xs-left tm-textbox tm-2-col-textbox">
                                                <p class="tm-text">
                                                    Hello everyone,Welcome to FengYe personal blog.
                                                        Here you can learn more useful things and find more useful resources.
                                                </p>
                                                <p class="tm-text">
                                                    I belong to the kind of cold exterior and warm interior.
                                                        If you have any questions,you can ask me,Let's learn and make progress together.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-2-col-right">
                                            <div class="text-xs-left tm-textbox tm-2-col-textbox">
                                                <p class="tm-text">This place hasn't figured out what to put in it yet.</p>
                                                <p class="tm-text">
                                                    This website belongs to personal website,In order to exercise their ability.
                                                        If you have any questions or good suggestions,Please click on the link at the bottom of the page to contact me!
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="tm-img-gallery-container">
                            ...
                            <div class="tm-img-gallery gallery-one">
                                ...
                                <div class="tm-img-gallery-info-container">
                                    ...
                                    <h2 class="tm-text-title tm-gallery-title">Blog HomePage</h2>
                                    <p class="tm-text">
                                        Here are some of my usual experience, recorded here, for easy learning and viewing, I hope we can make progress together.
                                    </p>
                        ...
                        <div class="tm-img-gallery-container">
                            ...
                            <div class="tm-img-gallery gallery-two">
                                ...
                                <div class="tm-img-gallery-info-container">
                                    ...
                                    <h2 class="tm-text-title tm-gallery-title"><span class="tm-white">Code HomePage</span></h2>
                                    <p class="tm-text">
                                        <span class="tm-white">Here are some codes I accumulated in my daily life. Share them for your reference. I hope we can make progress together.</span>
                                    </p>
        ...
        <footer class="tm-footer">
            ...
            <div class="tm-footer-copyright">
                <p class="tm-copyright-text">
                    If you have any questions or suggestions on this website, please contact me 
                        <a href="tencent://AddContact/?fromId=45&fromSubId=1&subcmd=all&uin=873514402&website=www.oicqzone.com" title="添加QQ好友">QQ:873514402</a>
                </p>
                <br />
                <p class="tm-copyright-text">
                    Copyright &copy; 2019 Fengye - 
                        <a href="http://www.miitbeian.gov.cn/" title="冀ICP备18039362号" target="_blank">冀ICP备18039362号</a>
                </p>
            </div>
        </footer>
    ...
    <script src="../Scripts/hero-slider-main.js"></script>
